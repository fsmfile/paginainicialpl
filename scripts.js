...
function fetchMenuItems() {
    fetch('https://raw.githubusercontent.com/fsmfile/paginainicialpl/master/menuItems.json')
        .then(response => response.json())
        .then(data => {
            menuItems = data;
            generateMenu(); // Gera o menu após carregar os dados
        })
...
document.addEventListener('DOMContentLoaded', function() {
    fetchMenuItems(); // Chama a função para buscar os dados
});
